...
1. Download **[float-positron-themes-0.2.0.vsix](https://github.com/firecat1234/positron-float-themes/releases/download/v0.2.0/float-positron-themes-0.2.0.vsix)** from the [latest release](https://github.com/firecat1234/positron-float-themes/releases/latest).
...
```powershell
positron --install-extension .\float-positron-themes-0.2.0.vsix
```
...
Fresh greens, blossom pink, and cool floral whites. Choose **Float Blossom** or **Float Blossom Night**.
...
npx --yes @vscode/vsce package --out float-positron-themes-0.2.0.vsix
```
